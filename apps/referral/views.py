...
and/or diagnosis code) it returns the ranked target departments to refer/link
to. It does NOT perform the referral write (that stays mcms_emr.referral).
"""
...
def _rule_rows():
    with connection.cursor() as cur:
        cur.execute(
            ...
            "to_department_id, priority, rationale, is_active "
...
class ReferralViewSet(viewsets.ViewSet):
    ...
    def recommend(self, request):
        ...
        seen = {}
        for to_id, name, prio, rationale in raw:
        ...
        return Response({"count": len(recs), "recommendations": recs})
